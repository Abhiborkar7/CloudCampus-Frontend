    ...
    <Suspense fallback={<div>Loading...</div>}>
      <Router>
        <Routes>
          ...
          <Route path="/student authority/*" element={<ProtectedRoute><StudentRoutes /></ProtectedRoute>} />
          <Route path="/faculty authority/*" element={<ProtectedRoute><FacultyRoutes /></ProtectedRoute>} />
